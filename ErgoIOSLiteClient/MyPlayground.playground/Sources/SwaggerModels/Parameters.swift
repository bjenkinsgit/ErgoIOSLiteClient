...
public struct Parameters: Codable {
    ...
    public init(height: Int, storageFeeFactor: Int, minValuePerByte: Int, maxBlockSize: Int, maxBlockCost: Int, blockVersion: String, tokenAccessCost: Int, inputCost: Int, dataInputCost: Int, outputCost: Int) {
        self.height = height
