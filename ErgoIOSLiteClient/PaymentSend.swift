...
//    @Environment(\.managedObjectContext) var managedObjectContext
    ...
    func updateEventCallback(tranzid: String) {
...
struct PaymentSend_Previews: PreviewProvider {
    static var previews: some View {
       ...
       //Test data
        ...
        newEvent.memo = "memo goes here"
        newEvent.sendToAddress = "3WynPS3DCQ8pD21vd6QGdSSThyUVn1fXoDVxn2AGEwFNshvz4Jzi"
        newEvent.sendToAmount = 1.25
        
               newEvent.timestamp = Date()
        return PaymentSend(event: newEvent).environment(\.managedObjectContext, context)
    }
}
